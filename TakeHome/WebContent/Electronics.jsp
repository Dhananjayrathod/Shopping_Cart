...
<br><br><br><br>
	...
	<form action="Mobile.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/mobile.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="mobile">
	...
	<form action="Laptop.jsp">
		<table >
			<tr>
				<td> <img src="img/laptop.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="laptop">
						
		   </tr>
	   </table>
      </form>

	<form action="Television.jsp">
		<table >
			<tr>
				<td> <img src="img/tv.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="Television">
		   </tr>
	   </table>
      </form>
      
      <form action="Microwave.jsp">
		<table >
			<tr>
				<td> <img src="img/micro.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Microwave">
