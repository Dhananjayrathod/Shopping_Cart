...
<br><br><br><br>
	...
	<form action="Book41.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/b41.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book41"><button  class="but1" type="button">Big Data Analytics   Rs:400/- </button></td>
	...
	<form action="Book42.jsp">
		<table >
			<tr>
				<td> <img src="img/b42.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book42" ><button  class="but2" type="button">The $100 Startups   Rs:200/- </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="Book43.jsp">
		<table >
			<tr>
				<td> <img src="img/b43.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="book43"><button  class="but3" type="button">Android 4 Application Development   Rs:999/- </button></td>
		   </tr>
	   </table>
      </form>
      
      <form action="Book44.jsp">
		<table >
			<tr>
				<td> <img src="img/b44.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book44"><button  class="but4" type="button">Head First Servlets and JSP   Rs:1,100 </button></td>
