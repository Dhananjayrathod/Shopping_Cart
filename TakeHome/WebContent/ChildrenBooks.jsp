...
<br><br><br><br>
	...
	<form action="Book21.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/b21.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book21"><button  class="but1" type="button">Things to Do  Rs:300/- </button></td>
	...
	<form action="Book22.jsp">
		<table >
			<tr>
				<td> <img src="img/b22.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book22" ><button  class="but2" type="button">Five Little Ducklings Rs:900/- </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="Book23.jsp">
		<table >
			<tr>
				<td> <img src="img/b23.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="book23"><button  class="but3" type="button">Cooking with Pooh  Rs:600/- </button></td>
		   </tr>
	   </table>
      </form>
      
      <form action="Book24.jsp">
		<table >
			<tr>
				<td> <img src="img/b24.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book24"><button  class="but4" type="button">Who's on First? Rs:1,100 </button></td>
