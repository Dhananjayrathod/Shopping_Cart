...
<br><br><br><br>
		...
		<img class="philips" src="img/philipstv.jpg" width="400px" height="300px" >
		<p class="name"> PHILIPS PLASMA</p>
      ...
      <form action="cart.jsp">
		<table >
			<tr>
				<td> <input class="sub"  type="submit" value="AddToCart" name="philipstv"></td>
