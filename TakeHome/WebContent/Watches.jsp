...
<br><br><br><br>
	...
	<form action="Watch1.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/wa1.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Watch1"><button  class="but1" type="button">L.U.C Swiss Rs:12590/- </button></td>
	...
	<form action="Watch2.jsp">
		<table >
			<tr>
				<td> <img src="img/wa2.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Watch2" ><button  class="but2" type="button">SKGEN Rs:8,800/- </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="Watch3.jsp">
		<table >
			<tr>
				<td> <img src="img/wa3.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="Watch3"><button  class="but3" type="button">SEIKO  Rs:24,000 </button></td>
		   </tr>
	   </table>
      </form>
      
      <form action="Watch4.jsp">
		<table >
			<tr>
				<td> <img src="img/wa4.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Watch4"><button  class="but4" type="button">Titan  Rs:9,500 </button></td>
