...
<br><br><br><br>
	...
	<form action="Apple.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/apple.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="apple"><button  class="but1" type="button">Apple iPhone 6  Rs:65,000 </button></td>
	...
	<form action="Sony.jsp">
		<table >
			<tr>
				<td> <img src="img/sony.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="sony" ><button  class="but2" type="button">Sony S23  Rs:35,000 </button></td>
	...
	<form action="Htc.jsp">
		<table >
			<tr>
				<td> <img src="img/htc.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="htc"><button  class="but3" type="button">HTC Light  Rs:25,000 </button></td>
		   </tr>
	   </table>
      </form>
      
      <form action="Samsung.jsp">
		<table >
			<tr>
				<td> <img src="img/samsung.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="samsung"><button  class="but4" type="button">Samsung S Duos  Rs:20,000 </button></td>
