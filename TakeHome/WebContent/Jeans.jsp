...
<br><br><br><br>
	...
	<form action="Jeans1.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/j1.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="jeans1"><button  class="but1" type="button">Killer Rs:2590/- </button></td>
	...
	<form action="Jeans2.jsp">
		<table >
			<tr>
				<td> <img src="img/j2.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="jeans2" ><button  class="but2" type="button">Levis Rs:5,800/- </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="Jeans3.jsp">
		<table >
			<tr>
				<td> <img src="img/j3.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="jeans3"><button  class="but3" type="button">Diesel  Rs:10,000 </button></td>
		   </tr>
	   </table>
      </form>
      
      <form action="Jeans4.jsp">
		<table >
			<tr>
				<td> <img src="img/j4.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="jeans4"><button  class="but4" type="button">Pepe jeans  Rs:3,500 </button></td>
