...
<br><br><br><br>
	...
	<form action="Jeans.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/jeans_banner.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Jeans">
	...
	<form action="Shoes.jsp">
		<table >
			<tr>
				<td> <img src="img/shoe_banner.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Shoes">
	...
	<form action="Wallet.jsp">
		<table >
			<tr>
				<td> <img src="img/wallet_banner.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="Wallet">
		   </tr>
	   </table>
      </form>
      ...
      <form action="Watches.jsp">
		<table >
			<tr>
				<td> <img src="img/watches_banner.jpeg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Watches">
