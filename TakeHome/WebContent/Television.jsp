...
<br><br><br><br>
	...
	<form action="Philips.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/philipstv.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="philipstv"><button  class="but1" type="button">PHILIPS  Rs:1,65,000 </button></td>
	...
	<form action="Sansui.jsp">
		<table >
			<tr>
				<td> <img src="img/sansuitv.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="sansuitv" ><button  class="but2" type="button">SANSUI Rs:45,000 </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="Onidatv.jsp">
		<table >
			<tr>
				<td> <img src="img/onidatv.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="onidvat"><button  class="but3" type="button">Onida Flatron  Rs:35,000 </button></td>
		   </tr>
	   </table>
      </form>
      ...
      <form action="LG.jsp">
		<table >
			<tr>
				<td> <img src="img/lgtv.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="lgtv"><button  class="but4" type="button">LG 21"  Rs:42,000 </button></td>
