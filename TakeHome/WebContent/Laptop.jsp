...
<br><br><br><br>
	...
	<form action="Alienware.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/alienware.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="alienware"><button  class="but1" type="button">Alienware  Rs:1,65,000 </button></td>
	...
	<form action="Dell.jsp">
		<table >
			<tr>
				<td> <img src="img/dell.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="dell" ><button  class="but2" type="button">DELL  Rs:45,000 </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="SonyLap.jsp">
		<table >
			<tr>
				<td> <img src="img/sonylap.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="sony"><button  class="but3" type="button">SONY  Rs:35,000 </button></td>
		   </tr>
	   </table>
      </form>
      ...
      <form action="Hp.jsp">
		<table >
			<tr>
				<td> <img src="img/hp.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="hp"><button  class="but4" type="button">HP S3  Rs:42,000 </button></td>
