...
<br><br><br><br>
	...
	<form action="Shoes1.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/s1.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Shoes1"><button  class="but1" type="button">Red Cheap Shoes Rs:6090/- </button></td>
	...
	<form action="Shoes2.jsp">
		<table >
			<tr>
				<td> <img src="img/s2.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Shoes2" ><button  class="but2" type="button">Black Berry Shoes Rs:15,800/- </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="Shoes3.jsp">
		<table >
			<tr>
				<td> <img src="img/s3.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="Shoes3"><button  class="but3" type="button">WoodLand  Rs:4,700 </button></td>
		   </tr>
	   </table>
      </form>
      
      <form action="Shoes4.jsp">
		<table >
			<tr>
				<td> <img src="img/s4.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="Shoes4"><button  class="but4" type="button">Ecco Shoes  Rs:3,500 </button></td>
