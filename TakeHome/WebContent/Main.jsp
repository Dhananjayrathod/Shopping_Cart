...
<form action="Electronics.jsp">
	<table >
		...
		<td> <p><a class="hovertext" href="#" title="ELECTRONICS"><img src="img/electronics.jpg" width="600px" height="300px" style="padding:00px 0px 0px 0px;" > </a></p></td>
		<td> <input type="submit" value="ShopNow" name="Electronics">
...
<form action="Books.jsp">
	<table>
		...
		<td> <p><a class="hovertext" href="#" title="BOOKS"><img src="img/books.jpg" width="600px" height="300px" style="padding:0px 0px 0px 0px;"></a></p></td>
		<td> <input type="submit" value="ShopNow" name="Books" >
...
<form action="Mens.jsp">
	<table>	
		...
		<td> <p><a class="hovertext" href="#" title="MENS"><img src="img/men.jpg"  width="600px" height="300px"  style="padding:00px 0px 0px 0px;" ></a></p></td>
		<td> <input type="submit" value="ShopNow" name="Mens"  >
		
		</tr>
		</table>
</form>
		
<form action="img/Womens.jsp">
	<table>	
		<tr>
		<td> <img src="img/add4.jpg" width="200px" height="300px" ></td>
		<td> <p><a class="hovertext" href="#" title="WOMEN"><img src="img/women.jpg" width="600px" height="300px"  style="padding:0px 0px 0px 0px;"></a></p></td>
		<td> <input type="submit" value="ShopNow" name="Womens" >
